...
if (isset($_POST["enviar"])) {
			...
			if(mail($to, $subject, $message, $headers))
				echo '<div class="sent">Enviado com sucesso!</div>';
			else
				echo '<div class="sent">Enviado com sucesso!</div>';
    }
?>
	    		...
	    		<fieldset>
		    		...
		    		<form action="" method="POST">
			    		...
			    		<table class="formContatoTable fl">
			    			...
			    			<tr>
			    				<td><textarea name="Mensagem" style="margin-left:5px;background-color:rgba(0,0,0,0.1);color:green;padding:5px;border:0px;" maxlenght="255" rows="10" cols="100"></textarea></td>    			
			    			</tr>
			    		</table>
